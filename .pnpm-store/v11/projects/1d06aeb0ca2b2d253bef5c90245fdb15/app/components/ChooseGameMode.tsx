...
const MODE_OPTIONS: ModeOption[] = [
  ...
  },
  {
    ...
    description: "Recreate celebrity expressions. Climb the leaderboard.",
    fill: "pink",
    cta: "Enter VIP",
          ...
          <div className="mt-6 flex-1 overflow-y-auto">
            <ul className="mx-auto flex w-full max-w-2xl flex-col gap-5 pb-6 sm:gap-6">
              {MODE_OPTIONS.map((option, index) => {
                ...
                const badgeText = isCelebrity && isVIP ? "VIP Active" : option.badge;
                return (
                  <motion.li
                    key={option.id}
                  ...
                  >
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isCelebrity
                          ? "bg-[var(--charcoal)] text-[var(--off-white)] hover:bg-[#333] sm:w-auto"
