  ...
  return (
    <div className="flex min-h-64 flex-col items-center justify-center gap-4 py-8" role="status" aria-live="polite">
      <motion.span
        ...
        className="flex h-16 w-16 items-center justify-center rounded-full border-[4px] border-[var(--ink-shadow)] border-t-[var(--purple)] on-accent bg-[var(--yellow)] text-2xl shadow-[4px_4px_0_0_var(--ink-shadow)]"
      >
        ✨
      </motion.span>
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <div className="mt-1 flex items-center gap-3 sm:gap-4">
        <span
          aria-hidden
          className="flex h-14 w-14 items-center justify-center rounded-2xl border-[3px] border-[var(--ink-shadow)] on-accent bg-[var(--yellow)] text-3xl shadow-[3px_3px_0_0_var(--ink-shadow)] sm:h-16 sm:w-16 sm:text-4xl sm:shadow-[4px_4px_0_0_var(--ink-shadow)]"
        >
