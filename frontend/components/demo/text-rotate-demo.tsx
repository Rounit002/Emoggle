...
// Upstream imports from "motion/react" — see the note at the top of
// components/ui/text-rotate.tsx for why this project uses framer-motion,
// which is the same library.
import { LayoutGroup, motion } from "framer-motion"

import { TextRotate } from "@/components/ui/text-rotate"

// Module-level so the array keeps its identity across renders.
const TEXTS = [
  "work!",
  "fancy ✽",
  "right",
